...
from diagram_chasing_games.python_tools import deep_get
from diagram_chasing_games.variable import Variable
from diagram_chasing_games.keyword import Keyword
...
class QuiverDiagram(StructuredNode):  
    ...
    def init_diagram(diagram):
        category = get_unique(Category, name='C')
